  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold tracking-tight mb-6">About LightningTalks</h1>
        
        <div className="prose prose-slate dark:prose-invert max-w-none mb-12">
          <h2>Our Mission</h2>
          <p className="text-lg">
            LightningTalks is dedicated to fostering knowledge sharing and community learning
            through concise, impactful technical presentations. We believe that everyone has
            valuable insights to share, and short-format talks make sharing accessible to all.
          </p>

          <h2>Our Story</h2>
          <p>
            Founded in 2025, LightningTalks emerged from a simple observation: some of the
            most valuable technical insights come from brief, focused presentations. We
            created a platform that makes it easy for developers to share their knowledge
            and for learners to discover new concepts quickly.
          </p>
        </div>
        ...
        <div className="bg-purple-50 dark:bg-purple-950 rounded-lg p-8 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-6">
            Whether you're here to share knowledge or learn something new,
