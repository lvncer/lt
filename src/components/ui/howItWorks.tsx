import { CheckCircle, Clock, Presentation as PresentationChart, Calendar } from "lucide-react";

const steps = [
  {
    icon: <PresentationChart className="h-10 w-10 text-purple-600" />,
    title: "1. Submit Your Talk",
    description: "Fill out a simple form with your talk details, including title, duration, and topic.",
  },
  {
    icon: <CheckCircle className="h-10 w-10 text-teal-600" />,
    title: "2. Get Approved",
    description: "Our team reviews your submission. Most talks are approved within 48 hours.",
  },
  {
    icon: <Calendar className="h-10 w-10 text-blue-600" />,
    title: "3. Schedule Presentation",
    description: "Once approved, you'll be notified of upcoming events where you can present.",
  },
  {
    icon: <Clock className="h-10 w-10 text-orange-500" />,
    title: "4. Present Your Talk",
    description: "Deliver your lightning talk in the allocated time slot and engage with the audience.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            From submission to presentation, we've made the process simple and straightforward
          </p>
        </div>
